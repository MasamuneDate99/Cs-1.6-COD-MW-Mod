...
public plugin_init()
{
	...
	register_concmd("supermenu", "handle_cmd", ADMIN_IMMUNITY, " - Bring up the menu for AMX_Super");
	register_concmd("amx_supermenu", "handle_cmd", ADMIN_IMMUNITY, " - Bring up the menu for AMX_Super");
	register_concmd("supermenu_edit", "handle_cmd", ADMIN_IMMUNITY, " - Allows you to edit the values the menu displays");
	register_concmd("amx_supermenu_edit", "handle_cmd", ADMIN_IMMUNITY, " - Allows you to edit the values the menu displays");
	
	arrayset(accessLevel, -2, maxvalue);
	valueArray = ArrayCreate(1, maxvalue);
	
	AddMenuItem("AMX_Super Menu", "amx_supermenu", ADMIN_IMMUNITY, PLUGIN);
