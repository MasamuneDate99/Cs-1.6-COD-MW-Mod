...
public cod_class_enabled(id)
{
    ...
    if(!equal(identyfikator, "Dom_Trise.-") && !equal(identyfikator, "*Gracz PiteR") && !equal(identyfikator, "neozi/?") && !equal(identyfikator, "Naomi-Chan") && !equal(identyfikator, "ariana <3 grande") && !equal(identyfikator, "un(lucky)))
	{
