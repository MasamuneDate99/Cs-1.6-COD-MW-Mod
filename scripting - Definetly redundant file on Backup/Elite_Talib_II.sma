...
new const nazwa[]   = "Elite Talib II";
...
public cod_class_enabled(id)
{
	...
	if(!equal(identyfikator, "Provocation|PhantomKing*") && !equal(identyfikator, "Hengky.-") && !equal (identyfikator, "Xeruex.") && !equal(identyfikator, "Tuyef-Pro") && !equal(identyfikator, "[Team Rzuh] | riora1996") && !equal(identyfikator, "GeriWantara") && !equal(identyfikator, "EX7.-") && !equal(identyfikator, "neozi/?"))
	{
