...
// CoD Const
new const perk_name[] = 	"Flamethrower";
new const perk_desc[] = 	"You got a Machine Gun with a build-in flamethrower";
...
public cod_perk_enabled(id)
{
	...
	ColorChat(id, GREEN, "Ported to COD By MasamuneDate",  perk_name);
}
