...
new const INFO_CLASS[]		= "[E] Skill Tapak Bumi With Delay 4 Seconds ( 0.4 * total Inteligence ), 1/2 Instant kill with keris";
new const P_CLASS_SKINS[] 	= "models/p_keris_gatotkaca.mdl";
new const V_CLASS_SKINS[]	= "models/v_keris_gatotkaca.mdl";
new const SENJATA_CLASS		= (1<<CSW_FIVESEVEN)|(1<<CSW_USP)|(1<<CSW_P90);
new const HEALTH_CLASS		= 10;
new const CONDITION_CLASS	= 45;
new const INTELEGENT_CLASS	= 10;
new const ENDURANCE_CLASS	= 0;
...
public Gempa_Now(id)
{
	...
	if(skill_hempas_bumi[id] == SKILL_USE_GEMPA)
	{
		...
		set_task(4.0, "Skill_Delay", id+50000)
	}
}
