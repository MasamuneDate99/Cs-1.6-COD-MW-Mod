...
public plugin_init()
{
	...
	cvar_skan_xp_hs = register_cvar("cod_skan_hs", "350"); // doswiadczenie za zabojstwo strzalem w glowe
	cvar_skan_xp_zabojstwo = register_cvar("cod_skan_zabojstwo", "100"); // doswiadczenie za normalne zabojstwo
