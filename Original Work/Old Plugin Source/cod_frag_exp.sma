...
public plugin_init() {
	...
	cvar_exp_1miejsce = register_cvar("cod_exp1", "3000"); // ilosc doswiadczenia za 1 miejsce 
	cvar_exp_2miejsce = register_cvar("cod_exp2", "2000"); // ilosc doswiadczenia za 2 miejsce 
	cvar_exp_3miejsce = register_cvar("cod_exp3", "1000"); // ilosc doswiadczenia za 3 miejsce
