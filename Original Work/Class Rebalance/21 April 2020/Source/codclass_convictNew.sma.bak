...
new const opis[] = "He sees the invisible, has 1/10 to drop weapon of the opponent Ak47 + 10 damage";
...
{
	precache_model("models/SawahCod/TYR/v_ak47-date.mdl");
}
...
public CurWeapon(id)
{
	...
	if(ma_klase[id])
	{
		if(weapon == CSW_AK47)
		{
			set_pev(id, pev_viewmodel2, "models/SawahCod/TYR/v_ak47-date.mdl")
		}
	}
}
