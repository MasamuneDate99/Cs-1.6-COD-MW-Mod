...
public plugin_init()
{
	...
	cod_register_perk("God's Crystal", "Grants immortality for 3 seconds. [Immune to all type of damage]");
...
public cod_perk_used(id)
{
	...
	set_task(GOD_TIME.3, "disablegod", id);
	perk_used[id] = true
