...
LoadTop(){
	...
	len += format(top_string[len], 1511 - len, "</table><hr size=1 color=#00CD00><font size=3 color=#FFFFFF>SawaHijau<font color=#00cd00> COD:MW Top 15 Level</center></body></html>");
