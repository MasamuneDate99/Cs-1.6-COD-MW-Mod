...
new const nazwa[] = "Elite Elektryk";
new const opis[] = "E to use lightning ";
new const bronie = 1<<CSW_P90 | 1<<CSW_DEAGLE | 1<<CSW_FLASHBANG ;
...
public cod_class_skill_used(id) {
	...
	{
		client_print(id,print_center,"No to the footprint of 750")
	...
	if(is_user_alive(target)){
		...
		if(poprzednia_blyskawica[id]+15.0>get_gametime()) {
			client_print(id,print_center,"Lightning you can use once every 15 seconds.");
			return PLUGIN_HANDLED;
		}
