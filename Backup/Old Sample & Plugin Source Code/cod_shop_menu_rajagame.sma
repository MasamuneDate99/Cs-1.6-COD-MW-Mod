	...
	switch(item_selected)
	{
		...
		case ITEM_ROULETTE:
		{
			...
			switch(roulette)
			{
				case 0:
				{
					new money_bonus = random_num(2000, 6000)
				...
				case 2:
				{
					new bonus_xp = random_num(1775, 4775)
				...
				case 3:
				{
					new bonus_health = random_num(20, 60)
				...
				case 4:
				{
					new lost_health = random_num(20, 60)
		...
		{
			new bonus_xp = random_num(2000, 6500)
			cod_set_user_xp(id, cod_get_user_xp(id) + bonus_xp)
