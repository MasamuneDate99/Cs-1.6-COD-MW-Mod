...
new const nazwa[]   = "Chesmik Support";
new const opis[]	= "12% chance of poisoning the enemy with every weapon. Poisoning takes 10HP by 4 seconds";
...
public Damage(id)
{
	...
	if(!task_exists(id+TASK_ZATRUCIE) && random(100) < 12)
...
public Zatruj(id)
{
	...
	client_print(zatruwajacy[id], print_center, "Zatrules enemy!");
