...
new const perk_name[] = "Flashing";
new const perk_desc[] = "You can close the eyes and protect yourself against flash files. Use [E]";
...
{
	client_print(id, print_chat,"[Flashing] Press the [E] button to close the eyes !");
	ma_perk[id] = true;
}
