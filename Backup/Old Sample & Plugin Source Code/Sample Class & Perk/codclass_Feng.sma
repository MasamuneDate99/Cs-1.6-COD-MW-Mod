...
#define CZAS_LADOWANIA 8 // Jak dlugo ma sie ladowac moc w sekundach

new bool:moc_zaladowana[33];
new bool:ma_klase[33];
new msg_bartime;

new const nazwa[] = "Feng";
new const opis[] = "After charging the knife, poison their enemies.";
...
public plugin_init() 
{
	register_plugin(nazwa, "1.0", "Zbysio");
