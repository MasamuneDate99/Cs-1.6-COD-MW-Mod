...
public plugin_init() {
	...
	iRandom = random_num(2,7);
	new szDesc[128];
	formatex(szDesc, 127, "You have 1 /% and chance to drop an opponent into the air and blinding it with a gun", iRandom);
	cod_register_perk("Stroke enemy", szDesc);
