...
new const nazwa[]   = "Archer";
new const opis[] = "You have arrows (E)";
new const bronie    = (1<<CSW_M4A1) | 1<<CSW_FLASHBANG | 1<<CSW_P228;
new const zdrowie   = 20;
new const kondycja  = 20;
new const inteligencja = 0;
new const wytrzymalosc = 10;

new cbow_bolt[]  = "models/rgcod/Crossbow_bolt.mdl"
...
public cod_class_skill_used(id)
{
	...
	{
		client_print(id, print_center, "In %d seconds you can use the power", czas)
