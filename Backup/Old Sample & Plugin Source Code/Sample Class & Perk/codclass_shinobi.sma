...
new const opis[] = "Gets the dual-katana LPM (40DMG + int) / PPM (80DMG). It is invisible and very fast.";
...
public plugin_init()
{
	...
	grawitacja = register_cvar("s_grawitacja", "300.0")
	niewidzialnosc = register_cvar("s_niewidzialnosc", "88") // 0 - 255
}
...
public Odrodzenie(id)
{
	if(ma_klase[id])
	{	
		set_user_gravity(id, 300.0/800.0);
