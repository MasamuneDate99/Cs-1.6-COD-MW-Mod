...
new PTB_MAXSIZE = 24 // maximum team size per team
new PTB_MAXDIFF = 2 // maximum team size difference
new PTB_AUTOROUNDS = 2 // number of first rounds into match, which allow autojoin only
...
new PTB_SWITCHMIN = 5 // number of minimum players on map for switching
