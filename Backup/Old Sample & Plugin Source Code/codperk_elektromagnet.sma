...
#include <hamsandwich>
#include <engine>
new const perk_name[] = "Military Elektromagnet";
new const perk_desc[] = "You get Elektromagnet, which suck all weapons and equipment";
...
public plugin_init()
{
	...
	pcvar_zasieg = register_cvar("cod_magnetradius", "450");
	pcvar_czas_dzialania = register_cvar("cod_magnettime", "30");
	pcvar_widocznosc_fali = register_cvar("cod_wavesvisibility", "3");
...
{	
	...
	{
		client_print(id, print_center, "Have already used an electromagnet!");
