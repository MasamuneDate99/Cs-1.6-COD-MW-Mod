...
new const nazwa[] = "New Saper";
new const opis[] = "Has 4 Mine";
...
public plugin_init() 
{
	...
	cod_register_advance(cod_get_classid("Saper"), 180, nazwa, opis, bronie, zdrowie, kondycja, inteligencja, wytrzymalosc);
...
{		
	...
	{
		client_print(id, print_center, "Have already used all the mines!");
