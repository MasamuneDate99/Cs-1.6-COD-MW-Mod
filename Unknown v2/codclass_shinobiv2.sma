...
#define PLUGIN "Dual Katana & Klasa Ninja"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
#define SLASH_DAMAGE (40+(cod_get_user_intelligence(id, 1, 1,1))/2)
...
#define STAB_DAMAGE (80+(cod_get_user_intelligence(id, 1, 1,1))/2)
...
new g_Old_Weapon[33], g_Ham_Bot, grawitacja, niewidzialnosc

new const nazwa[] = "Ethereal Blade";
new const opis[] = "Only Knife, each 2 Int equals 1 Dmg, its fast, hsa low gravity, and low invisibility";
new const bronie = 1<<CSW_KNIFE | 1<<CSW_HEGRENADE | 1<<CSW_SMOKEGRENADE ;
new const zdrowie = 10;
new const kondycja = 160;
...
public plugin_init()
{
	...
	grawitacja = register_cvar("s_grawitacja", "500.0")
	niewidzialnosc = register_cvar("s_niewidzialnosc", "55") // 0 - 255
}
...
public cod_class_enabled(id)
{
            ...
            set_user_gravity(id, get_pcvar_float(grawitacja) /800.0);
            set_rendering(id,kRenderFxNone, 0, 0, 0, kRenderTransAlpha, get_pcvar_num(niewidzialnosc));
